...
public class DockPane extends StackPane implements EventHandler<DockEvent> {
    ...
    public DockPane() {
        ...
        dockPosButtons = FXCollections
                .observableArrayList(dockTop, dockRight, dockBottom, dockLeft, dockTopRoot, dockRightRoot, dockBottomRoot, dockLeftRoot);
    ...
    public void dock(Node node, DockPos dockPos, Node sibling) {
        ...
        Orientation requestedOrientation = (dockPos == DockPos.LEFT || dockPos == DockPos.RIGHT) ? Orientation.HORIZONTAL
