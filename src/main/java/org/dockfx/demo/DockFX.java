...
public class DockFX extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        tableView.getColumns()
                .addAll(new TableColumn<String, String>("A"), new TableColumn<String, String>("B"), new TableColumn<String, String>("C"));
        ...
        // after both the left and right node's are docked the center docks end up with 50% of the
        // width
        ...
        ToolBar toolBar = new ToolBar(new Button("New"), new Button("Open"), new Button("Save"), new Separator(), new Button("Clean"), new Button("Compile"), new Button("Run"), new Separator(), new Button("Debug"), new Button("Profile"));
        ...
        // TODO: after this feel free to apply your own global stylesheet using the StyleManager
        // class
    }
