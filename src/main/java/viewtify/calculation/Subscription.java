...
public interface Subscription {
    ...
    /**
     * Returns a new aggregate subscription whose {@link #unsubscribe()} method calls
     * {@code unsubscribe()} on both this subscription and {@code other} subscription.
     */
    ...
    /**
     * Returns a new aggregate subscription whose {@link #unsubscribe()} method calls
     * {@code unsubscribe()} on all arguments to this method.
     */
