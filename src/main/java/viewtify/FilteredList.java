 ...
 */
class FilteredList<Out, In> extends AbstractList<Out> implements ObservableList<Out> {
     ...
     * @param mapper
     */
    FilteredList(CalculationList<In> source, Function<? super In, ? extends Out> mapper) {
        this.source = source;
        this.mapper = mapper;
