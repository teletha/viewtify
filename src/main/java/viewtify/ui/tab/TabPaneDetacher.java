...
/**
 * A simple Utility to make all {@link Tab}s of a {@link TabPane} detachable. <br>
 * <h1>Usage</h1> To get a {@link TabPane} in charge of control: <br>
 * <b>Hint: Only already added {@link Tab}s are going to be in charge of control!</b> <pre>
 * {@code
...
public class TabPaneDetacher {
    ...
    /**
     * Opens the content of the given {@link Tab} in a separate Stage. While the content is removed
     * from the {@link Tab} it is added to the root of a new {@link Stage}. The Window title is set
     * to the name of the {@link Tab};
     *
